...
def rename(placeholders):
    ...
    for isbn in _dir:
        ...
        if len(img) > 0:
            ...
            try:
                os.rename(
                    os.path.join(placeholders, isbn, filename + file_extension),
...
def main():
    ...
    YOUR_BUCKET_NAME = "bookshop-images-f1492f08-f236-4a55-afb7-70ded209cb27"
